...
public interface IConfiguracionRolTorneoRepository
{
    ...
    Task<ConfiguracionRolTorneoDto?> InsertarAsync(CreateConfiguracionRolTorneoRequest request, Guid usuarioId, CancellationToken ct = default);
