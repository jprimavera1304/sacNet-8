...
public interface IInscripcionesTorneoRepository
{
    ...
    Task<InscripcionTorneoDto?> InsertarAsync(CreateInscripcionTorneoRequest request, Guid usuarioId, CancellationToken ct = default);
