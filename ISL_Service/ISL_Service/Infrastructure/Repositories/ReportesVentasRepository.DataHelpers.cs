...
public partial class ReportesVentasRepository
{
    ...
    private static DataTable BuildLegacyExcelTable(int idReporte, DataTable source)
    {
        var columns = idReporte switch
        {
            ...
            ReporteCompraAcumuladores => CompraAcumuladoresExcelColumns,
            ReporteCompraProductos => CompraProductosExcelColumns,
            ReporteComprasFacturas => ComprasFacturasExcelColumns,
            ReporteVentasConcentradosDetalle => VentasConcentradosDetalleExcelColumns,
            ReporteInventarioAcumuladores or ReporteInventarioProductos or ReporteInventarioFiltros => InventarioActualExcelColumns,
            ReporteInventarioAcumuladoresCosto or ReporteInventarioProductosCosto or ReporteInventarioFiltrosCosto => InventarioActualCostoExcelColumns,
            ReporteInventarioFaltanteAcumuladores or ReporteInventarioFaltanteProductos or ReporteInventarioFaltanteFiltros => InventarioFaltanteExcelColumns,
            ReporteAjustesInventario => AjustesInventarioExcelColumns,
            ReporteMovimientosAlmacen => MovimientosAlmacenExcelColumns,
            ReportePedidoAcumuladores or ReportePedidoProductos => PedidoInventarioExcelColumns,
